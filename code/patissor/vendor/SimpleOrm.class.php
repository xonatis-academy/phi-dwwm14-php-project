...
// On créé une variable afin de donner les infos utiles à SimpleOrm pour se connecter à la base de données
$conn = new mysqli('127.0.0.1', 'root', '', 'patissor', '3306');

// On lui donne l'ordre de se connecter à la base de données
SimpleOrm::useConnection($conn, 'patissor');
